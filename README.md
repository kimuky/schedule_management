...
|선택 일정 수정|`PUT`|/api/schedules/{schedule_id}|요청 param, 요청 body|수정 정보|200: 정상 수정, 400: 비정상 값, 404: 일정이 사라짐|
|선택 일정 삭제|`DELETE`|/api/schedules/{schedule_id}| 요청 param | 삭제 정보 |200: 정상 삭제, 404: 일정이 사라짐|
...
|유저 수정|`PUT`|/api/users/{user_id}|요청 param, 요청 body|수정 정보|200: 정상 수정, 400: 비정상 값, 404: 일정이 사라짐|
